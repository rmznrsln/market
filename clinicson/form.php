...
<body>
    <div class="form-container">
        ...
        <div class="success-screen">
            ...
            <a href="hasta.php" class="btn-new-form">
        ...
        <!-- Form Body -->
        <div class="form-body">
            <a href="hasta.php" class="back-link">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="nationality" class="form-select" id="nationalitySelect">
                                ...
                                <option value="CZ">Çekya (CZ)</option>
                                ...
                                <option value="MK">Kuzey Makedonya (MK)</option>
                                <option value="ME">Karadağ (ME)</option>
                                <option value="XK">Kosova (XK)</option>
                                ...
                                <option value="SY">Suriye (SY)</option>
                                <option value="IQ">Irak (IQ)</option>
                                <option value="IR">İran (IR)</option>
                                <option value="IL">İsrail (IL)</option>
                                <option value="PS">Filistin (PS)</option>
